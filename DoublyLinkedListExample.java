...
class DoublyLinkedListExample {
    ...
    public static void main (String [] args) {
      ...
      System.out.print ("Forward doubly-linked list: ");
      temp = topForward;
      while (temp != null) {
      ...
      System.out.print ("Backward doubly-linked list: ");
      temp = topBackward;
      while (temp != null) {
        System.out.print (temp.name);
        temp = temp.prev;
      ...
      // Dump forward singly linked list
      System.out.print ("Forward doubly-linked list (after deletion): ");
      temp = topForward;
      while (temp != null)
      {
        System.out.print (temp.name);
      ...
      // Dump backward singly linked list
      System.out.print ("Backward doubly-linked list (after deletion): ");
      temp = topBackward;
      while (temp != null) {
        System.out.print (temp.name);
        temp = temp.prev;
